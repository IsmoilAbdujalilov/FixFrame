    ...
    <section className="news-view">
      ...
      <div className="news-view__background" style={backgroundStyle}>
        <div className="container">
          ...
          <p className="news-view__background-text">
      ...
      <div className="container">
        <ul className="news-view__questions">
          <li className="news-view__question">
            <h3 className="news-view__question-title">Our Expertise:</h3>
          ...
          <li className="news-view__question">
            <h3 className="news-view__question-title">Why Choose FixFrame?</h3>
            <ul className="news-view__answers">
              <li className="news-view__answer">
                <p className="news-view__answer-text">
          ...
          <li className="news-view__question">
            <h3 className="news-view__question-title">Our Services:</h3>
            <ul className="news-view__answers">
              <li className="news-view__answer">
                <p className="news-view__answer-text">
          ...
          <li className="news-view__question">
            <h3 className="news-view__question-title">Health and Safety:</h3>
            <ul className="news-view__answers">
              <li className="news-view__answer">
                <p className="news-view__answer-text">
          ...
          <li className="news-view__question">
            <h3 className="news-view__question-title">Service Areas:</h3>
            <ul className="news-view__answers">
              <li className="news-view__answer">
                <p className="news-view__answer-text">
          ...
          <li className="news-view__question">
            <h3 className="news-view__question-title">news Us:</h3>
            <ul className="news-view__answers">
              <li className="news-view__answer">
                <p className="news-view__answer-text">
